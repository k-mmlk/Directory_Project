...
const HeroSection = () => {
  return (
    ...
    >
      ...
      <div
        className="absolute top-0 lg:!top-32 z-20 text-white py-6 w-full mx-auto"
      ...
      >
        <div className="container mx-auto flex px-5 w-fit md:!w-[75%] py-14 md:!py-24 items-center justify-center flex-col">
          <div className="text-center lg:!text-start w-full">
            <h1 className="title-font text-[16px] font-bold tracking-[6.4px] text-pink-600 text-sm mb-6">
              THE BEST HOLIDAY EXPERIENCE
            </h1>
            <p className="!mb-9 leading-relaxed !text-3xl md:!text-[72px] font-bold">
              Stay like a local
            </p>
            <form
              action=""
              className="block text-gray-400 p-3 lg:px-2 lg:py-1 bg-white rounded-xl lg:!rounded-full w-full"
            >
              <div className="grid !grid-row-4 lg:!grid-cols-5 gap-2">
                ...
                <input
                  ...
                  className="block col-span-2 p-2 text-![16px] text-gray-900 border border-transparent border-r-0 rounded-r-none border-r-gray-200 rounded-lg bg-gray-50  focus:ring-0 focus:border-0 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                />
                <input
                  type="text"
                ...
                <select
                  name=""
                  id=""
                  className="block w-full p-2 col-span-2 lg:col-span-1 border-r-0 rounded-r-none border-r-gray-200 font-bold text-[12.8px] border-transparent rounded-lg bg-gray-50  focus:ring-0 focus:border-0 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white "
                >
                ...
                <button className="bg-blue-700 font-bold lg:ms-1 text-white rounded-full py-1 lg:!px-6 w-full col-span-2 lg:col-span-1 ">
                  SEARCH
                </button>
              </div>
            </form>
